...
from app.core.db import Base, DATABASE_URL  # Импортируем URL базы из db.py
from app.models import User, Profile, Goal, Activity, Workout, WorkoutInfo, Meal, MealFoodItem, FoodItem, TestQuestion, TestResult

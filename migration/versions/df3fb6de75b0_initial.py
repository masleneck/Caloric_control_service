...
Revision ID: df3fb6de75b0
Revises:
Create Date: 2025-04-20 11:01:39.434865
...
def upgrade() -> None:
    ...
    op.create_table(
        "users",
        sa.Column(
            "email", postgresql.CITEXT(length=120), nullable=False
        ),
        sa.Column(
            "hashed_password", sa.String(length=86), nullable=False
        ),
        sa.Column(
            "is_superuser",
            sa.Boolean(),
    ...
    op.create_table(
        ...
        sa.Column(
            "gender",
            sa.Enum("MALE", "FEMALE", "NOT_STATED", name="gender"),
            server_default=sa.text("'NOT_STATED'"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["food_item_id"], ["food_items.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "idx_meal_food_composite",
        "meal_food_items",
        ["meal_id", "food_item_id"],
        unique=True,
    )
    op.create_index(
        "idx_meal_food_food_id",
        "meal_food_items",
        ["food_item_id"],
        unique=False,
    )
    op.create_index(
        "idx_meal_food_meal_id",
        "meal_food_items",
        ["meal_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "idx_meal_food_meal_id", table_name="meal_food_items"
    )
    op.drop_index(
        "idx_meal_food_food_id", table_name="meal_food_items"
    )
    op.drop_index(
        "idx_meal_food_composite", table_name="meal_food_items"
    )
